...
{% for imagehub_command in resourcespace.imagehub_commands %}
  '{{ imagehub_command }}'{% if not loop.last %},{% endif %}
...
{% for imagehub_curl_call in resourcespace.imagehub_curl_calls %}
  '{{ imagehub_curl_call}}'{% if not loop.last %},{% endif %}
...
# {ref} will be automatically replaced by the corresponding resource ID by the plugin.
$iiif_imagehub_manifest_url = '{{ imagehub.service_url }}{{ imagehub.main_iiif_version }}/{ref}/manifest.json';
